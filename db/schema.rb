...
ActiveRecord::Schema[8.0].define(version: 2025_09_17_183600) do
  ...
  create_table "lecture_students", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_lecture_students_on_user_id"
  end
  ...
  add_foreign_key "lecture_students", "lectures"
  add_foreign_key "lecture_students", "users"
